...
<nav class="shadow p-3 mb-5 bg-body rounded navbar navbar-expand navbar-light bg-light container">
    ...
    <ul class="navbar-nav">
        <li class="navitem  navbar-nav nav-link activs img-responsive"><a href="index.php"><img data-bs-toggle=" tooltip" data-bs-placement="bottom" data-bs-html="true" title="Home" src="logo.png" alt=""></a></li>
